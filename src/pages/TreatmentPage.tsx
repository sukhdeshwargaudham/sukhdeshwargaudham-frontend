...
const TreatmentPage = () => {
  ...
  const columns = [
    ...
    // },
    {
      ...
      minWidth: "120px",
      cell: (row: Treatment) => (
        <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold inline-flex items-center justify-center min-w-[80px] ${
          row.status === "Recovered" ? "bg-green-100 text-green-700" :
          ...
          <div className="p-4 border-b border-border bg-muted/20 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
                  statusFilter === "Ongoing" ? "bg-blue-500 text-white" : "bg-blue-50 text-blue-600 hover:bg-blue-100"
                }`}
              >
                Recovering
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
                  statusFilter === "Recovered" ? "bg-green-500 text-white" : "bg-green-50 text-green-600 hover:bg-green-100"
                }`}
              >
                Recovered
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
                  statusFilter === "Death" ? "bg-red-500 text-white" : "bg-red-50 text-red-600 hover:bg-red-100"
                }`}
              >
                Death
              </button>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <span className={`px-2 py-0.5 rounded text-xs font-bold ${
                          viewingTreatment.status === "Recovered" ? "bg-green-100 text-green-700" :
