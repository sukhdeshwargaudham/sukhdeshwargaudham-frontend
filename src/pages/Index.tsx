...
const Index = () => {
  ...
  const handleSendWish = async (person: any) => {
    ...
    try {
      // gau_dham template: ONE variable {{1}} = full wish message body
      // Header image is required — use a pre-hosted Cloudinary birthday banner
      const BIRTHDAY_BANNER_URL = "https://res.cloudinary.com/dhqqkrk0s/image/upload/v1/birthday_banner.jpg";

      const wishMessage = `🎂 જન્મદિવસની હાર્દિક શુભેચ્છાઓ, ${person.name}! 🎂

🌸 જય શ્રી કૃષ્ણ 🌸
💐 ભગવાન શ્રી કૃષ્ણ અને ગૌમાતા આપને સદાય સુખ, શાંતિ, આરોગ્ય અને સમૃદ્ધિ આપે તેવી હાર્દિક પ્રાર્થના. 🙏

શ્રી જળારામ ગૌ સેવા ટ્રસ્ટ ગાંધીનગર ને સર્વે મનોકામના પૂર્ણ કર ગૌમાતા ની અપાર કૃપા બની રહે તેવી ગૌમાતા ને હૃદયપૂર્વક પ્રાર્થના. 🙏
